...
<head>
    ...
    <link rel="shortcut icon" href="https://demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/assets/img/favicon.png">
...
<li><a href="Author/others/authors-list.html" class="d-block link-black-100 py-1">Authors List</a></li>
...
<div class="media">
<a href="#" class="d-block"><img src="HTTPS://DEMO2.MADRASTHEMES.COM/BOOKWORM-HTML/REDESIGNED-OCTO-FIESTA/assets/img/150x226/img6.jpg" class="img-fluid" alt="image-description"></a>
...
<div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
<div class="woocommerce-loop-product__thumbnail">
<a href="../shop/single-product-v1.html" class="d-block"><img src="{{$Book->BookSampleImage1}}" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
</div>
<div class="woocommerce-loop-product__body product__body pt-3 bg-white">
<div class="text-uppercase font-size-1 mb-1 text-truncate"><a href="../shop/single-product-v1.html">Paperback</a></div>
<h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark"><a href="../shop/single-product-v1.html">All You Can Ever Know: A Memoir</a></h2>
...
<div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
<div class="woocommerce-loop-product__thumbnail">
<a href="../shop/single-product-v1.html" class="d-block"><img src="HTTPS://DEMO2.MADRASTHEMES.COM/BOOKWORM-HTML/REDESIGNED-OCTO-FIESTA/assets/img/150x226/img9.jpg" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
</div>
<div class="woocommerce-loop-product__body product__body pt-3 bg-white">
<div class="text-uppercase font-size-1 mb-1 text-truncate"><a href="../shop/single-product-v1.html">Paperback</a></div>
<h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark"><a href="../shop/single-product-v1.html">Think Like a Monk: Train Your Mind for Peace and Purpose Everyday</a></h2>
...
<div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
<div class="woocommerce-loop-product__thumbnail">
<a href="../shop/single-product-v1.html" class="d-block"><img src="HTTPS://DEMO2.MADRASTHEMES.COM/BOOKWORM-HTML/REDESIGNED-OCTO-FIESTA/assets/img/150x226/img10.jpg" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
</div>
<div class="woocommerce-loop-product__body product__body pt-3 bg-white">
<div class="text-uppercase font-size-1 mb-1 text-truncate"><a href="../shop/single-product-v1.html">Paperback</a></div>
<h2 class="woocommerce-loop-product__title product__title h6 text-lh-md mb-1 text-height-2 crop-text-2 h-dark"><a href="../shop/single-product-v1.html">The Overdue Life of Amy Byler</a></h2>
...
<img class="img-fluid" src="HTTPS://DEMO2.MADRASTHEMES.COM/BOOKWORM-HTML/REDESIGNED-OCTO-FIESTA/assets/img/60x92/img1.jpg" alt="Image-Description">
</a>
...
<div class="media d-md-flex">
<a class="d-block" href="../shop/single-product-v3.html">
<img class="img-fluid" src="HTTPS://DEMO2.MADRASTHEMES.COM/BOOKWORM-HTML/REDESIGNED-OCTO-FIESTA/assets/img/60x92/img2.jpg" alt="Image-Description">
</a>
<div class="media-body ml-3 pl-1">
<h6 class="font-size-2 text-lh-md font-weight-normal">
...
<div class="media d-md-flex">
<a class="d-block" href="../shop/single-product-v3.html">
<img class="img-fluid" src="HTTPS://DEMO2.MADRASTHEMES.COM/BOOKWORM-HTML/REDESIGNED-OCTO-FIESTA/assets/img/60x92/img3.jpg" alt="Image-Description">
</a>
<div class="media-body ml-3 pl-1">
<h6 class="font-size-2 text-lh-md font-weight-normal">
